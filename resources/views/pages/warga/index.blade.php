        ...
        <div class="card shadow-lg border-0 rounded-3">
            ...
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h3 class="mb-0"></h3>
                    <a href="{{ route('datamasyarakat.create') }}" class="btn btn-primary">
                            ...
                            <div class="card-body d-flex flex-column">
                                ...
                                <div class="action-buttons mt-auto">
                                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                        <a href="{{ route('datamasyarakat.edit', $w->warga_id) }}" class="btn btn-warning btn-sm me-md-2">
                                            <i class="fas fa-edit me-1"></i> Edit
                                        </a>
                                        <form action="{{ route('datamasyarakat.destroy', $w->warga_id) }}" method="POST" class="d-inline">
                                            @csrf @method('DELETE')
