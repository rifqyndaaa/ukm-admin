                ...
                <div class="col-md-3 mb-4">
                    <div class="card shadow-sm h-100">
                        ...
                        @if ($media)
                            ...
                            @else
                                <div class="p-3 text-center bg-light" style="height: 180px;">
                                    <a href="{{ asset('storage/' . $media->file_url) }}" target="_blank" class="btn btn-info mt-5">
                                        Lihat File
                                    </a>
                                </div>
                            @endif
                        ...
                        <div class="card-body">
                            ...
                            <p class="mb-1">
                                <strong>Harga:</strong> Rp {{ number_format($p->harga, 0, ',', '.') }}
                            </p>

                            <p class="mb-1">
                                <strong>UMKM:</strong> {{ $p->umkm->nama_usaha }}
                            </p>
                        ...
                        <div class="card-footer bg-white d-flex justify-content-between">
                            <a href="{{ route('produk.edit', $p->produk_id) }}" class="btn btn-warning btn-sm w-50 me-1">
                                Edit
                            </a>
