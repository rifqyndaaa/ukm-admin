            ...
            <nav class="navbar navbar-expand-lg bg-white navbar-light py-2 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto">
                        <a href="{{ route('umkm.index') }}" class="nav-item nav-link active">data warga</a>
...
<div class="container mt-4">
    <div class="card shadow-lg border-0 rounded-3">
        ...
        <div class="card-body">
            ...
            <h2>Data Warga</h2>
    <a href="{{ route('datamasyarakat.create') }}" class="btn btn-primary mb-3">Tambah Warga</a>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="{{ route('datamasyarakat.edit', $w->warga_id) }}" class="btn btn-warning btn-sm">Edit</a>
                    <form action="{{ route('datamasyarakat.destroy', $w->warga_id) }}" method="POST" style="display:inline-block;">
                        @csrf @method('DELETE')
